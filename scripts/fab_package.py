...
def stackup(board: str) -> dict:
    """The numbers a human has to type into PCBWay's order form, read off the board."""
...
BOARD
  Layers ................ {s['copper_layers']} (F.Cu, In1.Cu, In2.Cu, B.Cu)
  Finished thickness .... {s['board_thickness_mm']} mm     <-- NOT the 1.6 mm default
  Surface finish ........ not specified in the stackup; ENIG recommended -- the board carries
                          0.5 mm-pitch TSOP and QFN lands and six optical fiducials
  Outline ............... in Edge.Cuts. The outline includes 13 shell holes and two routed
                          openings INSIDE footprints (SW1's switch shaft, VR2's wheel), so
                          the router has to follow Edge.Cuts, not the board's bounding box
  Castellations ......... none
  Edge plating .......... none
...
THINGS A HUMAN HAS TO TELL THEM
  ...
  3. U1 and U2's lands take salvaged or new parts respectively; U1 is not on the BOM at all
     because no distributor sells it.
